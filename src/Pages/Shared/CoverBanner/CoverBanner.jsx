...
const CoverBanner = ({ bgImage, title }) => {
    return (
        <div style={{ backgroundImage: `url(${bgImage})` }} className='bg-cover lg:p-44 p-8'>
            <div className='bg-gray-800 bg-opacity-60 lg:px-32 px-10 lg:py-20 py-8 mt-20 mx-auto text-white text-center'>
